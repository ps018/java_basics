...
public class DataSource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:D:\\JAVA\\Music\\src\\" + DB_NAME;
    public static final String TABLE_ALBUMS = "albums";
    public static final String COLUMN_ALBUM_NAME = "name";
    public static final String COLUMN_ALBUM__ID = "_id";
    ...
    public static final String QUERY_ARTIST_FOR_SONG_START =
            "SELECT " + TABLE_ARTISTS + "." + COLUMN_ARTIST_NAME + ", " +
                    ...
                    TABLE_ALBUMS + "." + COLUMN_ALBUM__ID + " INNER JOIN " +
    ...
    public static final String CREATE_ARTIST_FOR_SONG_VIEW = "CREATE VIEW IF NOT EXISTS " +
            ...
            COLUMN_SONG_TITLE + " FROM " + TABLE_SONGS + " INNER JOIN " + TABLE_ALBUMS +
            " ON " + TABLE_SONGS + "." + COLUMN_SONG_ALBUM + " = " + TABLE_ALBUMS + "." +
            COLUMN_ALBUM__ID + " INNER JOIN " + TABLE_ARTISTS + " ON " + TABLE_ALBUMS +"."+
            COLUMN_ALBUM_ARTIST + " = " + TABLE_ARTISTS + "." + COLUMN_ARTIST_ID + " ORDER BY "+
             TABLE_ARTISTS + "." + COLUMN_ARTIST_NAME + ", " + TABLE_ALBUMS + "." +
    ...
    public static final String QUERY_ALBUM = "SELECT " + COLUMN_ALBUM__ID +
...
//    }
    ...
    public int getCount(String table){
        ...
        try (Statement statement = conn.createStatement();
        ResultSet results = statement.executeQuery(sql)){
            int count = results.getInt(1);  //            int count = results.getInt("count");
            int min = results.getInt(2);    //            int count = results.getInt("min_id");
    ...
    public List<SongArtist> querySongInfoView(String title){
        try{
            querySongInfoView.setString(1, title);//1 means first question mark
    ...
    public void insertSong(String title, String artist, String album, int track){
        try {
            ...
            try {
                ...
                System.out.println("OhBoy! Things are really bad! " + e2.getMessage());
            }
        }finally {
            try {
